...
interface IMarketplaceFacet {
    event Add(
        ...
        uint256 indexed _contractTokenId,
        uint256 _minPeriod,
        uint256 _maxPeriod,
    ...
    event Remove(uint256 indexed _eNft, address indexed _caller);
    event Withdraw(uint256 indexed _eNft, address indexed _caller);
